...
HD_PWD='C:/Users/nicom/Desktop/CORDIC_vivado/CORDIC_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finalBox.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finalBox.tcl

...
HD_PWD='C:/Users/nicom/Desktop/CORDIC_vivado/CORDIC_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log finalBox.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source finalBox.tcl -notrace
